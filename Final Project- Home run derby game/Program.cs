...
Longest home run= {Math.Round(cpuMaxDistance, 2)} feet!");
    ...
    private static void HitDirectionCalculator(ref int fenceDistance, int fenceDistanceL, int fenceDistanceC, int fenceDistanceR, double hitterDirectionLOdds, double hitterDirectionROdds)
    {
